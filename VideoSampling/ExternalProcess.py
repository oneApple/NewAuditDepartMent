...
if __name__ == '__main__':  
    #xeMgr = ExternalProcess("python")  
    os.system("python ../VlcMedia/VlcInterface.py ../media/a/output.mpg")
    p = subprocess.Popen(args = "vlc ../media/a/output.mpg",shell=True)  
    #p.wait()
    #xeMgr.run( "../media/a/output.mpg")  
