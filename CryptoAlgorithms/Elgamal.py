...
if __name__ == '__main__':
    ...
    m1 = e2.EncryptoList(StringToList("7890fdaaaaaaaaaaaaaaaaasfaaaaaaaaaaaaaaaaaaaaaaaaaaamessage12345678901234567890"))
    str1 = ",".join(m1)
    s1 = e1.EncryptoList(m1)
    m2 = e1.EncryptoList(StringToList("message12345678901234567890daaaaaaaaaaaaaaaaasfaaaaaaaaaaaaaaaaaaaaaaaaaa"))
